...
@section('content')
    <div data-craftly-path="resources/views/posts/index.blade.php" class="mb-4 flex items-center justify-between">
        <div>
    ...
    @if ($posts->isEmpty())
        {{-- Empty state --}}
        <div data-craftly-path="resources/views/posts/index.blade.php" class="rounded-lg border border-gray-200 bg-white px-6 py-16 text-center shadow-sm">
            <div data-craftly-path="resources/views/posts/index.blade.php" class="mx-auto mb-4 flex h-16 w-16 items-center justify-center rounded-full bg-gray-100">
            ...
            <div data-craftly-path="resources/views/posts/index.blade.php" class="mt-6">
    ...
    @else
        {{-- Data table --}}
        <div data-craftly-path="resources/views/posts/index.blade.php" class="overflow-x-auto rounded-lg border border-gray-200 bg-white shadow-sm">
        ...
        <div data-craftly-path="resources/views/posts/index.blade.php" class="mt-4">
            {{ $posts->links() }}
        </div>
    @endif
@endsection
