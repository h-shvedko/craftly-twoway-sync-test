...
@section('content')
    <div class="mb-4 flex items-center justify-between">
        <h2 class="text-xl font-bold text-gray-800">All Post</h2>
    ...
    @if ($posts->isEmpty())
        ...
        <div class="rounded-lg border border-gray-200 bg-white px-6 py-16 text-center shadow-sm">
            ...
            <h3 class="text-lg font-semibold text-gray-800">No Post yet</h3>
            <p class="mt-1 text-sm text-gray-500">Create your first Post to get started.</p>
            <div class="mt-6">
