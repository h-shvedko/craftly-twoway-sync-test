...
@section('content')
    <div class="mx-auto max-w-2xl rounded-lg border border-gray-200 bg-white p-6 shadow-sm">
        ...
        <div class="mt-6 flex items-center gap-3">
            <a href="{{ route('admin.tags.edit', $tag) }}" class="rounded-lg px-4 py-2 text-sm font-medium text-white" style="background-color: var(--color-primary-600);">
                Edit
            </a>
            ...
            <a href="{{ route('admin.tags.index') }}" class="text-sm text-gray-500 hover:underline">Back to list</a>
        </div>
    </div>
@endsection
